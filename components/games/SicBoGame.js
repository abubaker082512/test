          ...
          if (payoutAmount > 0) {
            try {
              ...
              if (payData.success) {
                setMessage({
                  type: 'success',
                  text: `🎉 Dice Result: [${finalDice.join(', ')}] Sum: ${sum}. Won Pi ${payoutAmount.toFixed(2)}!`
                })
              }
            } catch (e) {
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '6px' }}>
            ...
            >
              ...
              {bets.Small > 0 && <span style={{ position: 'absolute', top: '-6px', right: '-4px', background: '#00e676', color: '#000', borderRadius: '50%', width: '20px', height: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '9px', fontWeight: 'bold' }}>Pi {bets.Small}</span>}
            </button>
            ...
            >
              ...
              {bets.Odd > 0 && <span style={{ position: 'absolute', top: '-6px', right: '-4px', background: '#ab47bc', color: '#fff', borderRadius: '50%', width: '20px', height: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '9px', fontWeight: 'bold' }}>Pi {bets.Odd}</span>}
            </button>
            ...
            >
              ...
              {bets.Even > 0 && <span style={{ position: 'absolute', top: '-6px', right: '-4px', background: '#ab47bc', color: '#fff', borderRadius: '50%', width: '20px', height: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '9px', fontWeight: 'bold' }}>Pi {bets.Even}</span>}
            </button>
            ...
            >
              ...
              {bets.Big > 0 && <span style={{ position: 'absolute', top: '-6px', right: '-4px', background: '#ff1744', color: '#fff', borderRadius: '50%', width: '20px', height: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '9px', fontWeight: 'bold' }}>Pi {bets.Big}</span>}
            </button>
          </div>
          ...
          >
            🎰 ANY TRIPLE (PAYS 30:1)
            {bets.AnyTriple > 0 && <span style={{ position: 'absolute', top: '-6px', right: '10px', background: '#ffea00', color: '#000', borderRadius: '50%', width: '20px', height: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '9px', fontWeight: 'bold', border: '1px solid #fff' }}>Pi {bets.AnyTriple}</span>}
          </button>
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '4px' }}>
              {[1, 2, 3, 4, 5, 6].map(num => (
                ...
                >
                  {num}
                  {bets[`Num${num}`] > 0 && <span style={{ position: 'absolute', top: '-10px', right: '-4px', background: '#2e7d32', color: '#fff', borderRadius: '50%', width: '16px', height: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '8px', fontWeight: 'bold' }}>Pi {bets[`Num${num}`]}</span>}
                </button>
              ))}
            </div>
          </div>
